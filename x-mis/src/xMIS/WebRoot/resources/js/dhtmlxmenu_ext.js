...
dhtmlXMenuObject.prototype.isItemHidden = function (id) {
	...
	if (this.idPull[this.idPrefix + id] != null) {
		WQ = (this.idPull[this.idPrefix + id].style.display == "none");
	}
	return WQ;
};
...
dhtmlXMenuObject.prototype.setTopText = function (text) {
	...
	if (this._topText == null) {
		...
		this._topText.className = "dhtmlxMenu_TopLevel_Text_" + (this._rtl ? "left" : (this.js == "left" ? "right" : "left"));
...
dhtmlXMenuObject.prototype.setAlign = function (align) {
	...
	if (align == "left" || align == "right") {
		...
		this.js = align;
		if (this._topText != null) {
			this._topText.className = "dhtmlxMenu_TopLevel_Text_" + (this.js == "left" ? "right" : "left");
		}
		this._redistribTopLevelPositions();
	}
};
...
dhtmlXMenuObject.prototype._addUpArrow = function (id) {
	...
	arrow.onmouseover = function () {
		...
		main_self._clearAllSelectedSubItemsInPolygon(this.FC);
		...
		main_self._doScrollUp(this.FC, true);
	};
...
dhtmlXMenuObject.prototype._addDownArrow = function (id) {
	...
	arrow.onmouseover = function () {
		...
		main_self._doScrollDown(this.FC, true);
	};
	arrow.onmouseout = function () {
		if (main_self.menuMode == "web") {
			window.clearTimeout(main_self.menuTimeoutHandler);
...
dhtmlXMenuObject.prototype._countPolygonItems = function (id) {
	...
	for (var a in this.itemPull) {
		...
		if (asv == this.idPrefix + id && (tp == "item" || tp == "radio" || tp == "checkbox")) {
			count++;
		}
	}
	return count;
