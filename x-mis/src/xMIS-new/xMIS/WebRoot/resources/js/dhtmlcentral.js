...
oM.fillImg="cm_fill.gif"; oM.fromTop=82; oM.fromLeft=155; oM.wait=300; oM.zIndex=400;
...
oM.makeMenu('m3','','物资管理','#');
oM.makeMenu('m4','','会议管理','#');
oM.makeMenu('m5','','客户关系管理','#','',160,0);
oM.makeMenu('m6','','缺陷管理','#');
oM.makeMenu('m7','','员工管理','#');
oM.makeMenu('m8','','产品管理','#');
oM.makeMenu('m9','','知识库管理','#');
oM.makeMenu('m10','','意见建议','#');

oM.makeMenu('m11','m1','DHTML Library','/projects/lib/?m=11','',120,0);
...
var itemCount = 10;
var avail="10+((1200-235)/"+itemCount+")";
oM.menuPlacement=new Array(10,avail,avail+"*2",avail+"*3",avail+"*4",avail+"*5",avail+"*6",avail+"*7",avail+"*8",avail+"*9");
oM.construct();