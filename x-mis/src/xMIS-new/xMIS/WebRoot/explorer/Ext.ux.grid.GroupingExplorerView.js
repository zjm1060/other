...
Ext.ux.grid.GroupingExplorerView = Ext.extend(Ext.ux.grid.ExplorerView, {
	...
	onAdd : function() {
		if (this.enableGrouping && !this.ignoreAdd) {
			...
			Ext.ux.grid.GroupingExplorerView.superclass.onAdd.apply(this,
					arguments);
		}
	},
	...
	onRemove : function(ds, record, index, isUpdate) {
		Ext.ux.grid.GroupingExplorerView.superclass.onRemove.apply(this,
				arguments);
	...
	refreshRow : function(record) {
		if (this.ds.getCount() == 1) {
			...
			Ext.ux.grid.GroupingExplorerView.superclass.refreshRow.apply(this,
					arguments);
	...
	doRender : function(cs, rs, ds, startRow, colCount, stripe) {
		...
		for (i = 0, len = groups.length; i < len; i++) {
			...
			buf[buf.length] = Ext.ux.grid.GroupingExplorerView.superclass.doRender
	...
	getRows : function() {
		if (!this.enableGrouping) {
			return Ext.ux.grid.GroupingExplorerView.superclass.getRows
					.call(this);
		}
		var r = [];
