...
public class WebKeys {
	...
	public static final String BBZ_SUM="T";
	
	public static final int IMPORT_STATE_SUCCESS = 1;//导入状态成功
	
	
	
	public static final String Session_Attribute_KQ_YESTERDAY_DATE="yesterdayDate";
	public static final String Session_Attribute_KQ_YESTERDAY_EARLY="yesterdayEarly";
	public static final String Session_Attribute_KQ_YESTERDAY_LATE="yesterdayLate";
	public static final String Session_Attribute_KQ_TODAY_EARLY="todayEarly";
	public static final String Session_Attribute_KQ_TODAY_DATE="todayDate";
	public static final String Session_Attribute_KQ_TODAY_LATE="todayLate";
}
