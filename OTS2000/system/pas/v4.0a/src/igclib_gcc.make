...
COMPILE.c = $(CC)
CFLAGS_igclib.LIB = $(CFLAGS) -c

###### Target: /home/ems/system/pas/v4.0a/lib/igclib.lib ###### 
TARGETDIR_igclib.LIB=/home/ems/system/pas/v4.0a/lib
CPPFLAGS_igclib.LIB += \
...
# Link or archive
/home/ems/system/pas/v4.0a/lib/igclib.lib: $(TARGETDIR_igclib.LIB) $(OBJS_igclib.LIB)
	$(AR) $(ARFLAGS) $@ $(OBJS_igclib.LIB)
