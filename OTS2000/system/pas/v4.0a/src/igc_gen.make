...
# Link or archive
$(TARGETDIR_igc_gen.dxe)/igc_gen.dxe: $(TARGETDIR_igc_gen.dxe) $(OBJS_igc_gen.dxe) $(DEPLIBS_igc_gen.dxe)
	$(LINK.c) $(CFLAGS_igc_gen.dxe) $(CPPFLAGS_igc_gen.dxe) -o $@ $(OBJS_igc_gen.dxe) $(LDLIBS_igc_gen.dxe)
