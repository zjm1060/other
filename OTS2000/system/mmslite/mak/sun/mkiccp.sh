...
make -f sun/mkmvl.mak    OPT=-g  DEFS=-DDEBUG_SISCO  PROJ=mvl_ld       # logging    / debug
cat cc.lst >> ../../../mak/sun/cc.lst
...
rm cc.lst
make -f sun/foundry.mak clean  		     
make -f sun/foundry.mak
cat cc.lst >> ../../../mak/sun/cc.lst
cd ../../..
...
rm cc.lst
make -f sun/mmslog.mak clean
make -f sun/mmslog.mak
cat cc.lst >> ../../../mak/sun/cc.lst
cd ../../..
...
rm cc.lst
make -f sun/micstcpe.mak OPT=-g  DEFS=-DDEBUG_SISCO  PROJ=micstcpe_ld   # logging    / debug
cat cc.lst >> ../../mak/sun/cc.lst
cd ../..
...
rm cc.lst
make -f sun/mitest.mak                              PROJ=mitest
cat cc.lst >> ../../mak/sun/cc.lst
cd ../..
