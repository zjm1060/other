...
cd mvl/src
rm cc.lst
make -f sun/mkmvl.mak
make -f sun/mkmvl.mak OPT=-g DEFS=-DDEBUG_SISCO              PROJ=mvld
make -f sun/mkmvl.mak        DEFS=-DMVL_UCA                  PROJ=mvlu
make -f sun/mkmvl.mak OPT=-g "DEFS=-DMVL_UCA -DDEBUG_SISCO"  PROJ=mvlud
