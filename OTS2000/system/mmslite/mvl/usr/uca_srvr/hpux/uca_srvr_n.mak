...
#*
#* To make the UCA_SRVR_N executable (no logging/no debug) enter the following:
#*
#* 	make -f uca_srvr_n.mak
#*
...
LIBS = $(LIBDIR)/mvlu_n.lib $(LIBDIR)/mmsl_n.lib $(LIBDIR)/mmsle_n.lib \
...
$(OBJDIR)/mmsop_en.o:	$(MMSSRCDIR)/mmsop_en.c $(INCLUDES)
	echo uca_srvr_n.mak: $(MMSSRCDIR)/mmsop_en.c $(LIST)
