...
#*
#* To make the UOSITCPE_LD executable (logging/debug) enter the following:
#*
#* 	make -f uca_srvr_ld.mak
#*
...
LIBS = $(LIBDIR)/mvlu_ld.lib $(LIBDIR)/mmsl_ld.lib $(LIBDIR)/mmsle_ld.lib \
...
$(OBJDIR)/mmsop_en.o:	$(MMSSRCDIR)/mmsop_en.c $(INCLUDES)
	echo uca_srvr_ld.mak: $(MMSSRCDIR)/mmsop_en.c $(LIST)
