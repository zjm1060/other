...
#*
#* To make the UOSITCPE_ND executable (no logging/debug) enter the following:
#*
#* 	make -f uca_srvr_nd.mak
#*
...
CFLAGS = -g -c -j -w3 -Od $(OPT) -I$(INCDIR) $(DEFS) -DMMS_LITE \
	 -DMOSI -DLEAN_T -I$(MMSOPDIR)  \
         -DMVL_UCA \
         -DETHERNET

LIBS = $(LIBDIR)/mvlu_nd.lib $(LIBDIR)/mmsl_nd.lib $(LIBDIR)/mmsle_nd.lib \
...
$(OBJDIR)/mmsop_en.o:	$(MMSSRCDIR)/mmsop_en.c $(INCLUDES)
	echo uca_srvr_nd.mak: $(MMSSRCDIR)/mmsop_en.c $(LIST)
