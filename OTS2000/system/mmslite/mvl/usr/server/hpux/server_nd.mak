...
#*
#* To make the SOSITCPE_ND executable (no logging/debug) enter the following:
#*
#* 	make -f server_nd.mak                      
#*
...
PROJ  = sositcpe_nd	# renamed so not confused with "server" directory
OPT   =
DEFS  =
LIST  = >> cc_nd.lst 2>&1
...
LIBS = $(LIBDIR)/mvl_nd.lib $(LIBDIR)/mmsl_nd.lib $(LIBDIR)/mmsle_nd.lib \
       $(LIBDIR)/asn1l_nd.lib $(LIBDIR)/mem_nd.lib \
       $(LIBDIR)/util_nd.lib $(LIBDIR)/ositcpe_nd.lib 
