...
#*
#* To make the SOSITCPE_N executable (no logging/no debugging) enter the following:
#*
#* 	make -f server_n.mak                      
#*
...
PROJ  = sositcpe_n	# renamed so not confused with "server" directory
OPT   =
DEFS  =
LIST  = >> cc_n.lst 2>&1
