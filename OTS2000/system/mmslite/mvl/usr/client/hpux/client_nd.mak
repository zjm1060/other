...
#*			       
#* To make the COSITCPE executable (no logging/debug) enter the following:
#*
#* 	make -f client_nd.mak
#*
...
PROJ  = cositcpe_nd    # renamed so not confused with "client" directory 
...
$(OBJDIR)/mmsop_en.o:	$(MMSSRCDIR)/mmsop_en.c $(INCLUDES)
	echo client_nd.mak: $(MMSSRCDIR)/mmsop_en.c $(LIST)
