...
#*			       
#* To make the COSITCPE_L executable (logging/no debug) enter the following:
#*
#* 	make -f client_l.mak
#*
...
PROJ  = cositcpe_l    # renamed so not confused with "client" directory 
...
$(OBJDIR)/mmsop_en.o:	$(MMSSRCDIR)/mmsop_en.c $(INCLUDES)
	echo client_l.mak: $(MMSSRCDIR)/mmsop_en.c $(LIST)
