	...
	{ 
		...
		switch (cmd_type)
		{
			...
			case C_BREAKER:
			{
				...
				if (devno>USER_BREAKER)	   	/* 32 breakers maximum of using now */
				{
			...
			case C_DEVICE:
			{
				...
				if (devno>USER_DEVICE)	  /* 128 devices maximum of using now */
				{
			...
			case C_GATE:
			{
				...
				if (devno>USER_GATE)	  /* 32 gates maximum of using now */
				{
