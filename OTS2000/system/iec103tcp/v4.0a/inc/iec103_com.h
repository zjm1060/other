...
//============================ 用 户 定 义 ===================================//
//本程序对于每个IP地址进行独立的处理，对应一个装置
/********add for tcp/ip*********/
#define IEC103_IP   	"192.169.11.120"
#define IEC103_PORT		5000
int	    iec_sock,   SockStatus; 
#define SOCKET_ERROR    (-1)
#define RECV_FLAGS      0
int		MakeLink();
/*****************/

#define	MAX_STN_NUM103	10			//保护装置的个数
...
static unsigned char station_addr[MAX_STN_NUM103+1]={ -1, 0x00};
		
static char	yc_file[MAX_STN_NUM103][200]=
	{
		"\\home\\ems\\h9000\\iec103tcp\\def\\rtu1_yc_def.txt" //1#站模拟量
	};

static char	yx_file[MAX_STN_NUM103][200]=
	{
		"\\home\\ems\\h9000\\iec103tcp\\def\\rtu1_yx_def.txt" //1#站开关量
	};
//======================================================================//
