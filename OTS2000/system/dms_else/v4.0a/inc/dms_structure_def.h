...
#define	RECORD_NAME_SIZE		12
#define RECORD_LONGNAME_SIZE    24
#define	ENTRY_NAME_SIZE	        16
#define ENTRY_LONGNAME_SIZE     40
#define ENTRY_NODENAME_SIZE     8
#define DSP_FILENAME_SIZE		24		/* relative display file name maxium length */		
#define ANLG_UNIT_NAME_SIZE     8
#define TERMINAL_NO_SIZE        12
#define CABINET_NO_SIZE        12
#define UNIT_NO_SIZE			8
#define SLOT_NO_SIZE			4
#define CHANNEL_NO_SIZE        8
#define	USR_NAME_SIZE			8
#define POINT_NAME_SIZE		STATION_NAME_SIZE+GROUP_NAME_SIZE+RECORD_NAME_SIZE+ENTRY_NAME_SIZE
...
typedef	struct		/* Entry descriptor - fixed portion */
{
	...
	CHAR		nodeName[ENTRY_NODENAME_SIZE];
...
#define	ENTRY_IMP_NUMBER	2000	
#define	ENTRY_ANLG_NUMBER	20000	
#define ENTRY_STATUS_NUMBER	50000	
#define	ENTRY_CHARA_NUMBER	2000	
#define ENTRY_CALC_NUMBER	2000	
#define ENTRY_CURVE_NUMBER	200	
#define ENTRY_DEVOBJ_NUMBER	2000	
