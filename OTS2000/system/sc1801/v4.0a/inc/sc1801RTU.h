...
/*
#define COMM_BUF_SIZE   SHM_COMM_SEG_SIZE
#define MAX_SEND_NUM    SHM_COMM_SEG_COUNTER

struct shm_send_seg {

        struct  lanh_ptr lan_head;
...
struct shm_send {
	short	head;
	short   flag;
    struct shm_send_seg 	shm_send_seg[MAX_SEND_NUM];
};
struct shm_send data_send_addr,*shm_send_addr;
*/
#define	DEBUG
#define	LINKADRESS	0
...
#define Com10_Baud_Rate  1200 

#ifdef SUN_OS
#define COM_PORT	"/dev/ttya"
...
#define RD_INTERVAL_TIMEOUT		(DWORD)(600000/Com1_Baud_Rate+1)
#define RD_TOTAL_TIMEOUT_MUL	(DWORD)(120000/Com1_Baud_Rate+1)
#define RD_TOTAL_TIMEOUT_CNT	(DWORD)(600000/Com1_Baud_Rate+1)
#define WT_TOTAL_TIMEOUT_MUL	(DWORD)(12000/Com1_Baud_Rate+1)
#define WT_TOTAL_TIMEOUT_CNT	(DWORD)(33000/Com1_Baud_Rate+1)
...
#define RERROR		0x1F		/*Report Error DATA*/
...
#define	RESOLUTE		0xfff

#define	DRFT_SEC		((365*30+7)*24*3600-8*3600)/*modified by gcl 040508*/
/*946684800*/
#define	cmdrecbuf		"/home/ems/h9000/his/sc1801/1801CMD_"

/*static char	*comstatus[]={"SYS.SYSMSG.YF_TD1","SYS.SYSMSG.YF_TD2"};*/
...
#define	SC1801_FILE_KEY		"/home/ems/h9000/sc1801"
#define	IEC_FILE_KEY		"/home/ems/h9000/iec104"
