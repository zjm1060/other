...
Unix  have  SYN  to  Windows  by chi  2007.05.09
...
#define			PrgN_MAN_TIME_SET			63   /*根据2010.5.13规约增加时间点设置 chichi*/
#define			MAX_PROG					64
...
{"Power","Openning","Flux"},/*APOWER  7*/
/* C_BREAKER 8 */	{"TestOpen","Open","Close","IM_Line","IIM_Line","Line_IM","Line_IIM","Tran_IM","Tran_IIM","IM_Tran","IIM_Tran","TestClose","CancelSyn","LoopClose","ChgVltCls","ZroVltCls"},
{"DataPolling"},/*DATA_POLLING  9*/
/* C_DEVICE 10 */	{"Off","On" },
/* C_DEV_MOD 11*/	{"Off","On","On2","On3" },
/* C_GATE 12*/		{"Open","Close","Stop","Up","Down","FastOpen","FastClose","StepUp",	
								"StepDown","Forward","Backward","SetZero","SetFlux"} ,
...
{"Power","Volt"},/*RPower  19*/
{"NULL","FaultReset","FailReset"},/*Signal_Reset 20*/
/* C_SPEED_STEP 21*/{"Decrease","Increase" },
/* C_SWITCH 22 */	{"Open","Close","TestOpen","TestClose" },
/* C_SYS_MOD_SET 23*/{"Off","On","On2","On3"},
/* C_TRANS 24*/		{"Raise","Down","Stop","RaiseTo","DownTo" },
	{"Start","Stop","Reset","NoVoltRun","NoLoadRun","BlackStart",         /*  C_Unit  */
							 ...
							 "DragLSStart","DragHSCmp","DragLSCmp","PumpToGe" }, 	/*C_UNIT  25*/
