...
#if defined(MMS_LITE) && !defined(FOUNDRY) && !defined(_WIN32) && !defined(_AIX)
...
#define SYSTEM_SEL_SYS_PSOS	0x0200
#define SYSTEM_SEL_NEW_SYSTEM	0x0400
...
#endif
#if !defined(SYS_PSOS)
#define	SYS_PSOS	SYSTEM_SEL_SYS_PSOS    
#endif
#if !defined(NEW_SYSTEM)
#define	NEW_SYSTEM	SYSTEM_SEL_NEW_SYSTEM  
#endif
...
#pragma message("Please look over at the Solaris system detect and defines")
...
/* DEC C OpenVMS							*/
/************************************************************************/
#if defined(__VAX) && defined(__VMS)   		/* OpenVMS VAXC         */

#pragma message("Please look over the  system detect & defines")
...
/************************************************************************/
/* PSOS Operating System with Diab Data C Compiler.			*/
/************************************************************************/
#if defined (PSOS_SYSTEM)	/* Usually define on compile command line.*/

#define SYSTEM_SEL	SYSTEM_SEL_SYS_PSOS
#define SD_END_STRUCT  long end_of;
...
/* IC86 embedded                                                        */
/************************************************************************/
#ifdef __IC86__  /* This should be defined automatically by compiler.    */

/* Use new system define since it's closest */
#define SYSTEM_SEL      SYSTEM_SEL_NEW_SYSTEM
#define SD_END_STRUCT
...
/************************************************************************/
/* NEW SYSTEM 								*/
/* This is a starting point for the addition of a new system		*/
/* The sample shown below assumes a Motorola 6800 family CPU and no 	*/
/* special quad word alignment requirements.				*/
/************************************************************************/

#if defined(NEW_SYSTEM_DETECT) 	
...
/************************************************************************/
/************************************************************************/
/* SISCO is now using DEBUG_SISCO across the board, but to help		*/
/* during the transition, provide the following detectors ...		*/

#if defined(DEBUG_ASN1)
#pragma message("Please use DEBUG_SISCO instead of DEBUG_ASN1")
#endif

#if defined(DEBUG_MMS)
#pragma message("Please use DEBUG_SISCO instead of DEBUG_MMS")
#endif

#if defined(DEBUG_SUIC)
#pragma message("Please use DEBUG_SISCO instead of DEBUG_SUIC")
#endif
