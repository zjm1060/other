...
typedef struct mvluTypeStruct 
  ...
  ST_RTINT offSet;	/* Offset from start of mother structure 	*/
...
#define RT_STR_END 	        18
#define RT_ARR_END 	        19
...
struct runtime_type
  ...
  ST_RTINT   offset_to_last; /* offset in bytes from the start of the 	*/
...
#if defined(MMS_LITE)
extern ST_RET (*u_ml_get_rt_type) (OBJECT_NAME *type_name, 
      			   RUNTIME_TYPE **rt_out, ST_INT *num_rt_out);
extern SD_CONST ST_INT numMvlRtNames;
extern SD_CONST ST_CHAR *SD_CONST mvlRtNames[];
#endif
...
ST_INT ms_asn1_to_runtime (ST_UCHAR *asn1, ST_UINT asn1len,
		     	   RUNTIME_TYPE *dest, ST_INT num_rt_dest);
...
ST_INT ms_runtime_create (ST_UCHAR *asn1_data, ST_UINT asn1_len,
                            RUNTIME_TYPE **pp_rt_table, ST_INT max_num_rt);
ST_VOID ms_runtime_destroy (RUNTIME_TYPE *rt_table, ST_INT num_rt);
/************************************************************************/
/*			ms_comp_name_find				*/
