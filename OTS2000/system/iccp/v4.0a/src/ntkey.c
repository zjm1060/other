...
/* --------  ---  ------   -------------------------------------------	*/
/* 06/25/97  EJV    05     Added define NO_F_KEY to allow function key	*/
/*                         to be 1,2,3,... Telnet do not like Fn keys.	*/
/* 05/14/97  EJV    04     Added back simulate_press_key function	*/
/* 05/12/97  IKE    03     Changed ST_INT to ST_RET in check_key	*/
