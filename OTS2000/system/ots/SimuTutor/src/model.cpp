...
void CModelForm::showEvent(QShowEvent *e)
{
	e->accept();
}
void  CModelForm::setLanguage(int language)
{	
	QTranslator translator;
	if(flag_simutrainee)
	{
...
void CModelAddForm::showEvent(QShowEvent *e)
{
	e->accept();
}
void  CModelAddForm::setLanguage(int language)
{	
	QTranslator translator;
	if(flag_simutrainee)
	{
