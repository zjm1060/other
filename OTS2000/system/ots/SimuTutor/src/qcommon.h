...
//记录屏幕像素
extern int  m_ActScreenX;
extern int  m_ActScreenY;
//记录TASKMANAGE生成实例数量
extern int  m_taskmanage_count;
extern bool dlg_created_flag[30];
extern bool flag_simutrainee;
...
extern int login_user_id,login_user_type;
extern int flag_langueage;//0:chinese 1:english
...
void	PopupMessageBox(QWidget *parent,char msg[],int type,bool ismodal = true);
void	HeartBeat();
...
bool jujgeIstUTorMachine();//DZY 140715 GET HOST IP TO JUJGE IF THIS MACHINE IS ABLE TO RUN TUTOR.EXE
bool jujgeIsTraineeMachine();
void CloseProcess(QString str);
int		GetUserTypeId(int user_id);
