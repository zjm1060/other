...
#include "doc_manage.h"//dzy
#include "contest.h"//dzy
...
class CTeacherManage : public QMainWindow,public Ui_CTeacherManage
{
	...
	public:
		...
		NetstateThreadTutor *m_NetstateThreadTutor;
		CContestTable *d_contest;
		CSetContestTable *d_setcontest;
		...
		Doc_manage *m_doc_manage;
		Study_plan *m_study_plan;
		CStudyRecTable *m_CStudyRecTable;
		QDialog *m_dlgbroadcast;
		QLineEdit *m_broadcast;
		QPushButton *buttonBroadcast;
		QPushButton *buttonquitBroadcast;
	...
	public slots:
		...
		void help();
		void openDoc_manage();
		void open_study_plan();
		void openStudyRecTable();
		void openContest_manage();
		void openSetContest();
		void show_tryconnectfail();
		void show_tryconnec(int i,bool j);
		void showsendBroadcast();
		void sendBroadcast();
};
