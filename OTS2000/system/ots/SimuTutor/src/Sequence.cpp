...
void SequenceList::showEvent(QShowEvent *event)
{
	event->accept();
}
void  SequenceList::setLanguage(int language)
{	
	QTranslator translator;
	if(flag_simutrainee)
	{
...
void SequenceEdit::showEvent(QShowEvent *event)
{
	event->accept();
}
void  SequenceEdit::setLanguage(int language)
{	
	QTranslator translator;
	if(flag_simutrainee)
	{
