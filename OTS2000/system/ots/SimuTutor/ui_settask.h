/********************************************************************************
** Form generated from reading ui file 'settask.ui'
**
** Created: Thu Jan 15 10:25:40 2015
...
public:
    ...
    QCheckBox *checkBoxusertype;
    QCheckBox *checkBox_examonly;
    ...
    void setupUi(QWidget *CSetTaskTable)
    {
        if (CSetTaskTable->objectName().isEmpty())
            CSetTaskTable->setObjectName(QString::fromUtf8("CSetTaskTable"));
        CSetTaskTable->resize(1208, 648);
        CSetTaskTable->setStyleSheet(QString::fromUtf8("font: 14pt \"\345\256\213\344\275\223\";"));
        gridLayout_4 = new QGridLayout(CSetTaskTable);
        ...
        gridLayout_5->addWidget(listUserAndGroups, 0, 0, 1, 1);

        verticalLayout = new QVBoxLayout();
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        checkBoxusertype = new QCheckBox(groupBox);
        checkBoxusertype->setObjectName(QString::fromUtf8("checkBoxusertype"));

        verticalLayout->addWidget(checkBoxusertype);

        checkBox_examonly = new QCheckBox(groupBox);
        checkBox_examonly->setObjectName(QString::fromUtf8("checkBox_examonly"));

        verticalLayout->addWidget(checkBox_examonly);
        ...
        gridLayout_5->addWidget(buttonSend, 4, 0, 1, 1);
    ...
    void retranslateUi(QWidget *CSetTaskTable)
    {
        CSetTaskTable->setWindowTitle(QApplication::translate("CSetTaskTable", "\344\273\273\345\212\241\350\256\276\347\275\256", 0, QApplication::UnicodeUTF8));
        ...
        checkBoxusertype->setText(QApplication::translate("CSetTaskTable", "\346\214\211\345\255\246\345\221\230\345\267\245\347\247\215\347\255\233\351\200\211\344\273\273\345\212\241", 0, QApplication::UnicodeUTF8));
        checkBox_examonly->setText(QApplication::translate("CSetTaskTable", "\345\217\252\347\234\213\345\257\206\351\242\230", 0, QApplication::UnicodeUTF8));
