/********************************************************************************
** Form generated from reading ui file 'historyrecOLD.ui'
**
** Created: Thu Jan 15 10:28:35 2015
**      by: Qt User Interface Compiler version 4.5.2
**
** WARNING! All changes made in this file will be lost when recompiling ui file!
********************************************************************************/

#ifndef UI_HISTORYRECOLD_H
#define UI_HISTORYRECOLD_H
...
public:
    ...
    void setupUi(QDialog *CHistoryRecTable)
    {
        if (CHistoryRecTable->objectName().isEmpty())
            CHistoryRecTable->setObjectName(QString::fromUtf8("CHistoryRecTable"));
        CHistoryRecTable->resize(974, 720);
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(CHistoryRecTable->sizePolicy().hasHeightForWidth());
        CHistoryRecTable->setSizePolicy(sizePolicy);
        gridLayout = new QGridLayout(CHistoryRecTable);
...
"color: rgb(255, 255, 255);"));
        ...
        gridLayout->addWidget(viewRec, 2, 0, 1, 1);

        QWidget::setTabOrder(timeStart, timeEnd);
        QWidget::setTabOrder(timeEnd, comboSearchName);
        QWidget::setTabOrder(comboSearchName, checkCmd);
        QWidget::setTabOrder(checkCmd, checkAlarm);
    ...
    void retranslateUi(QDialog *CHistoryRecTable)
    {
        CHistoryRecTable->setWindowTitle(QApplication::translate("CHistoryRecTable", "\345\216\206\345\217\262\350\256\260\345\275\225\346\237\245\350\257\242", 0, QApplication::UnicodeUTF8));
