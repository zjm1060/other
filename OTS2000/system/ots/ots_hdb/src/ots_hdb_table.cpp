...
int		cvt_userinfo(DB_FMT *p_data,int mode)
{
	...
	if(p_data->flag.flag_userinfo.user_range == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"user_range");
			sprintf(field_value[i],"%d",p_data->seg.seg_userinfo.user_range);
		}
		else
		{
			p_data->seg.seg_userinfo.user_range=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_userinfo.user_type_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"user_type_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_userinfo.user_type_id);
		}
		else
		{
			p_data->seg.seg_userinfo.user_type_id=atoi(field_value[i]);
		}
		i++;
	}
...
int		cvt_train_info(DB_FMT *p_data,int mode) 
{
	...
	if(p_data->flag.flag_train_info.inter_mode == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"inter_mode");
			sprintf(field_value[i],"%d", p_data->seg.seg_train_info.inter_mode );
		}
		else
		{
			p_data->seg.seg_train_info.inter_mode=atoi(field_value[i]);    
		}
		i++;
	}
	if(p_data->flag.flag_train_info.task_startable == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"task_startable");
			sprintf(field_value[i],"%d", p_data->seg.seg_train_info.task_startable );
		}
		else
		{
			p_data->seg.seg_train_info.task_startable=atoi(field_value[i]);				
		}
		i++;
	}
	if(p_data->opr_mode == DB_SELECT||p_data->opr_mode==DB_FUZZY_SELECT)
...
int		cvt_task(DB_FMT *p_data,int mode) 
{
	...
	//DZY 14 HN
	if(p_data->flag.flag_task.user_range == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"user_range");
			sprintf(field_value[i],"%d",p_data->seg.seg_task.user_range);
		}
		else
		{
			p_data->seg.seg_task.user_range=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_task.user_type_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"user_type_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_task.user_type_id);
		}
		else
		{
			p_data->seg.seg_task.user_type_id=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_task.task_userange == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"task_userange");
			sprintf(field_value[i],"%d",p_data->seg.seg_task.task_userange);
		}
		else
		{
			p_data->seg.seg_task.task_userange=atoi(field_value[i]);
		}
		i++;
	}
	//
...
int		cvt_send_task(DB_FMT *p_data,int mode) 
{
	...
	if(p_data->flag.flag_send_task.score == 1)
	{
		if(mode == 0)
		{
			...
			sprintf(field_value[i],"'%.1f'",p_data->seg.seg_send_task.score);
		}
		else
		{
	...
	if(p_data->flag.flag_send_task.tutor_score == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"tutor_score");
			sprintf(field_value[i],"'%.1f'",p_data->seg.seg_send_task.tutor_score);
		}
		else
		{
			p_data->seg.seg_send_task.tutor_score=atof(field_value[i]);						
		}
		i++;
	}
	if(p_data->opr_mode == DB_SELECT||p_data->opr_mode==DB_FUZZY_SELECT)
...
int		cvt_score(DB_FMT *p_data,int mode) 
{
	...
	if(p_data->flag.flag_score.user_id == 1)
	{
		...
		{
			strcpy(field_name[i],"user_id");
			if(p_data->seg.seg_score.user_id != CONST_NEG )
			{
	...
	if(p_data->flag.flag_score.score == 1)
	{
		...
		{
			strcpy(field_name[i],"score");
			sprintf(field_value[i],"%.1f",p_data->seg.seg_score.score);
			field_type[i] = TYPE_FLOAT;
		}
		else
		{
	...
	if(p_data->flag.flag_score.step == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"step");
			sprintf(field_value[i],"%d",p_data->seg.seg_score.step);
		}
		else
		{
			p_data->seg.seg_score.step=atoi(field_value[i]);				
		}
		i++;
	}
	...
	if(p_data->opr_mode == DB_SELECT||p_data->opr_mode==DB_FUZZY_SELECT)
	{
		...
		if(mode == 0)
		{
			strcpy(field_name[i],"(select name from subject where subject_id=score.subject_id) as subject_name");
		}
		else
		{
...
{
	int i=0,k=1;	
	if(p_data->flag.flag_user_type.user_type_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"user_type_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_user_type.user_type_id);
		}
		else
		{
			p_data->seg.seg_user_type.user_type_id=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_user_type.user_type_name == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"user_type_name");
			sprintf(field_value[i],"'%s'",p_data->seg.seg_user_type.user_type_name);
		}
		else
		{
			strcpy(p_data->seg.seg_user_type.user_type_name,field_value[i]);
		}
		i++;
	}
	
	data_user_type[row_id] = p_data->seg.seg_user_type;	
	//*p_data->rec.p_groups[row_id] = p_data->seg.seg_groups;
...
{
	int i=0,k=1;	
	if(p_data->flag.flag_doc.doc_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"doc_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_doc.doc_id);
		}
		else
		{
			p_data->seg.seg_doc.doc_id=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_doc.doc_app == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"doc_app");
			sprintf(field_value[i],"%d",p_data->seg.seg_doc.doc_app);
		}
		else
		{
			p_data->seg.seg_doc.doc_app=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_doc.doctype_id== 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"doctype_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_doc.doctype_id);
		}
		else
		{
			p_data->seg.seg_doc.doctype_id=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_doc.update_time== 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"update_time");
			sprintf(field_value[i],"'%s'",p_data->seg.seg_doc.update_time);
		}
		else
		{
			strcpy(p_data->seg.seg_doc.update_time,field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_doc.user_type_id== 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"user_type_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_doc.user_type_id);
		}
		else
		{
			p_data->seg.seg_doc.user_type_id=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_doc.name == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"name");
			sprintf(field_value[i],"'%s'",p_data->seg.seg_doc.name);
		}
		else
		{
			strcpy(p_data->seg.seg_doc.name,field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_doc.study_points == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"study_points");
			sprintf(field_value[i],"%d",p_data->seg.seg_doc.study_points);
		}
		else
		{
			p_data->seg.seg_doc.study_points=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_doc.studytime == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"studytime");
			sprintf(field_value[i],"%d",p_data->seg.seg_doc.studytime);
		}
		else
		{
			p_data->seg.seg_doc.studytime=atoi(field_value[i]);
		}
		i++;
	}
	
	data_doc[row_id] = p_data->seg.seg_doc;	
	//*p_data->rec.p_groups[row_id] = p_data->seg.seg_groups;
...
{
	int i=0,k=1;	
	if(p_data->flag.flag_doc_type.doctype_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"doctype_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_doc_type.doctype_id);
		}
		else
		{
			p_data->seg.seg_doc_type.doctype_id=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_doc_type.name == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"name");
			sprintf(field_value[i],"'%s'",p_data->seg.seg_doc_type.name);
		}
		else
		{
			strcpy(p_data->seg.seg_doc_type.name,field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_doc_type.cope_name == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"cope_name");
			sprintf(field_value[i],"'%s'",p_data->seg.seg_doc_type.cope_name);
		}
		else
		{
			strcpy(p_data->seg.seg_doc_type.cope_name,field_value[i]);
		}
		i++;
	}
	data_doc_type[row_id] = p_data->seg.seg_doc_type;	
	//*p_data->rec.p_groups[row_id] = p_data->seg.seg_groups;
...
{
	int i=0,k=1;	
	if(p_data->flag.flag_study_plan.plan_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"plan_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_study_plan.plan_id);
		}
		else
		{
			p_data->seg.seg_study_plan.plan_id=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_study_plan.doc_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"doc_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_study_plan.doc_id);
		}
		else
		{
			p_data->seg.seg_study_plan.doc_id=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_study_plan.plan_num == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"plan_num");
			sprintf(field_value[i],"%d",p_data->seg.seg_study_plan.plan_num);
		}
		else
		{
			p_data->seg.seg_study_plan.plan_num=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_study_plan.study_points == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"study_points");
			sprintf(field_value[i],"%d",p_data->seg.seg_study_plan.study_points);
		}
		else
		{
			p_data->seg.seg_study_plan.study_points =atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_study_plan.studytime == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"studytime");
			sprintf(field_value[i],"%d",p_data->seg.seg_study_plan.studytime);
		}
		else
		{
			p_data->seg.seg_study_plan.studytime=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_study_plan.task_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"task_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_study_plan.task_id);
		}
		else
		{
			p_data->seg.seg_study_plan.task_id=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_study_plan.task_score == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"task_score");
			sprintf(field_value[i],"%d",p_data->seg.seg_study_plan.task_score);
		}
		else
		{
			p_data->seg.seg_study_plan.task_score=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_study_plan.user_type_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"user_type_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_study_plan.user_type_id);
		}
		else
		{
			p_data->seg.seg_study_plan.user_type_id=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_study_plan.name == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"name");
			sprintf(field_value[i],"'%s'",p_data->seg.seg_study_plan.name);
		}
		else
		{
			strcpy(p_data->seg.seg_study_plan.name,field_value[i]);
		}
		i++;
	}
	
	data_study_plan[row_id] = p_data->seg.seg_study_plan;	
	//*p_data->rec.p_groups[row_id] = p_data->seg.seg_groups;
...
{
	int i=0,k=1;	
	if(p_data->flag.flag_study_record.user_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"user_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_study_record.user_id);
		}
		else
		{
			p_data->seg.seg_study_record.user_id=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_study_record.host_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"host_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_study_record.host_id);
		}
		else
		{
			p_data->seg.seg_study_record.host_id=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_study_record.date_time == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"date_time");
			sprintf(field_value[i],"'%s'",p_data->seg.seg_study_record.date_time);
			field_type[i] = TYPE_TIME;
		}
		else
		{
			strcpy(p_data->seg.seg_study_record.date_time,field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_study_record.ms == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"ms");
			sprintf(field_value[i],"%d",p_data->seg.seg_study_record.ms);
		}
		else
		{
			p_data->seg.seg_study_record.ms=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_study_record.type == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"type");
			sprintf(field_value[i],"%d",p_data->seg.seg_study_record.type);
		}
		else
		{
			p_data->seg.seg_study_record.type=atoi(field_value[i]);
		}
		i++;
	}

	if(p_data->flag.flag_study_record.plan_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"plan_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_study_record.plan_id);
		}
		else
		{
			p_data->seg.seg_study_record.plan_id=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->flag.flag_study_record.points == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"points");
			sprintf(field_value[i],"%d",p_data->seg.seg_study_record.points);
		}
		else
		{
			p_data->seg.seg_study_record.points=atoi(field_value[i]);
		}
		i++;
	}
	if(p_data->opr_mode == DB_SELECT||p_data->opr_mode==DB_FUZZY_SELECT)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"(select name from host where host_id=study_record.host_id) as host_name");
		}
		else
		{
			strcpy(p_data->seg.seg_study_record.host_name,field_value[i]);					
		}
		i++;//k++;
	}				
	if(p_data->opr_mode == DB_SELECT||p_data->opr_mode==DB_FUZZY_SELECT)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"(select longname from userinfo where user_id=study_record.user_id) as user_name");
		}
		else
		{
			strcpy(p_data->seg.seg_study_record.user_name,field_value[i]);					
		}
		i++;//k++;
	}	
	if(p_data->opr_mode == DB_SELECT||p_data->opr_mode==DB_FUZZY_SELECT)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"(select name from study_plan where plan_id=study_record.plan_id) as plan_name");
		}
		else
		{
			strcpy(p_data->seg.seg_study_record.plan_name,field_value[i]);					
		}
		i++;//k++;
	}	

	data_study_record[row_id] = p_data->seg.seg_study_record;	
	//*p_data->rec.p_groups[row_id] = p_data->seg.seg_groups;
...
{
	int i=0,k=1;	
	if(p_data->flag.flag_contest.contest_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"contest_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_contest.contest_id);
		}
		else
		{
			p_data->seg.seg_contest.contest_id=atoi(field_value[i]);				
		}
		i++;
	}
	if(p_data->flag.flag_contest.name == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"name");
			sprintf(field_value[i],"'%s'",p_data->seg.seg_contest.name);
		}
		else
		{
			strcpy(p_data->seg.seg_contest.name,field_value[i]);				
		}
		i++;
	}
	if(p_data->flag.flag_contest.task_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"task_id");
			...
			if(p_data->seg.seg_contest.task_id != CONST_NEG )
			{
				sprintf(field_value[i],"%d",p_data->seg.seg_contest.task_id);
			}
			else
			{
				strcpy(field_value[i],"null");
		...
		{
			p_data->seg.seg_contest.task_id=atoi(field_value[i]);				
		}
		i++;
	}
	if(p_data->flag.flag_contest.scene_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"scene_id");
			...
			if(p_data->seg.seg_contest.scene_id != CONST_NEG )
			{
				sprintf(field_value[i],"%d",p_data->seg.seg_contest.scene_id);
			}
			else
			{
				strcpy(field_value[i],"null");
		...
		{
			p_data->seg.seg_contest.scene_id=atoi(field_value[i]);				
		}
		i++;
	}
	if(p_data->flag.flag_contest.fault_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"fault_id");
			...
			if(p_data->seg.seg_contest.fault_id != CONST_NEG )
			{
				sprintf(field_value[i],"%d",p_data->seg.seg_contest.fault_id);
			}
			else
			{
				strcpy(field_value[i],"null");
		...
		{
			p_data->seg.seg_contest.fault_id=atoi(field_value[i]);				
		}
		i++;
	}
	if(p_data->flag.flag_contest.open_state == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"open_state");
			sprintf(field_value[i],"%d",p_data->seg.seg_contest.open_state);
		}
		else
		{
			p_data->seg.seg_contest.open_state=atoi(field_value[i]);				
		}
		i++;
	}
	if(p_data->flag.flag_contest.datetime == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"datetime");
			sprintf(field_value[i],"'%s'",p_data->seg.seg_contest.datetime);
			field_type[i] = TYPE_TIME;
		}
		else
		{
			strcpy(p_data->seg.seg_contest.datetime,field_value[i]);				
		}
		i++;
	}
	if(p_data->flag.flag_contest.remark == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"remark");
			sprintf(field_value[i],"'%s'",p_data->seg.seg_contest.remark);
		}
		else
		{
			strcpy(p_data->seg.seg_contest.remark,field_value[i]);				
		}
		i++;
	}
	...
	if(p_data->opr_mode == DB_SELECT||p_data->opr_mode==DB_FUZZY_SELECT)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"(select name from task where task_id=contest.task_id) as task_name");
		}
		else
		{
			strcpy(p_data->seg.seg_contest.task_name,field_value[i]);					
		}
		i++;//k++;
		if(mode == 0)
		{
			strcpy(field_name[i],"(select name from scene where scene_id=contest.scene_id) as scene_name");
		}
		else
		{
			strcpy(p_data->seg.seg_contest.scene_name,field_value[i]);					
		}
		i++;//k++;
		if(mode == 0)
		{
			strcpy(field_name[i],"(select name from fault where fault_id=contest.fault_id) as fault_name");
		}
		else
		{
			strcpy(p_data->seg.seg_contest.fault_name,field_value[i]);					
		}
		i++;//k++;
	}			
	
	data_contest[row_id] = p_data->seg.seg_contest;		
	//*p_data->rec.p_task[row_id] = p_data->seg.seg_task;
...
{
	int i=0,k=1;	
	if(p_data->flag.flag_send_contest.send_contest_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"send_contest_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_send_contest.send_contest_id);
		}
		else
		{
			p_data->seg.seg_send_contest.send_contest_id=atoi(field_value[i]);					
		}
		i++;
	}
	if(p_data->flag.flag_send_contest.contest_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"contest_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_send_contest.contest_id);
		}
		else
		{
			p_data->seg.seg_send_contest.contest_id=atoi(field_value[i]);				
		}
		i++;
	}
	if(p_data->flag.flag_send_contest.group_id == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"group_id");
			sprintf(field_value[i],"%d",p_data->seg.seg_send_contest.group_id);
		}
		else
		{
			p_data->seg.seg_send_contest.group_id=atoi(field_value[i]);				
		}
		i++;
	}
	if(p_data->flag.flag_send_contest.contest_state == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"contest_state");
			sprintf(field_value[i],"%d",p_data->seg.seg_send_contest.contest_state);
		}
		else
		{
			p_data->seg.seg_send_contest.contest_state=atoi(field_value[i]);				
		}
		i++;
	}
	if(p_data->flag.flag_send_contest.send_time == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"send_time");
			sprintf(field_value[i],"'%s'",p_data->seg.seg_send_contest.send_time);
			field_type[i] = TYPE_TIME;
		}
		else
		{
			strcpy(p_data->seg.seg_send_contest.send_time,field_value[i]);				
		}
		i++;
	}

	if(p_data->flag.flag_send_contest.start_time == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"start_time");
			sprintf(field_value[i],"'%s'",p_data->seg.seg_send_contest.start_time);
			field_type[i] = TYPE_TIME;
		}
		else
		{
			strcpy(p_data->seg.seg_send_contest.start_time,field_value[i]);				
		}
		i++;
	}
	if(p_data->flag.flag_send_contest.end_time == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"end_time");
			sprintf(field_value[i],"'%s'",p_data->seg.seg_send_contest.end_time);
			field_type[i] = TYPE_TIME;
		}
		else
		{
			strcpy(p_data->seg.seg_send_contest.end_time,field_value[i]);				
		}
		i++;
	}
	if(p_data->flag.flag_send_contest.time_len == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"time_len");
			sprintf(field_value[i],"%d",p_data->seg.seg_send_contest.time_len);
		}
		else
		{
			p_data->seg.seg_send_contest.time_len=atoi(field_value[i]);				
		}
		i++;
	}
	if(p_data->flag.flag_send_contest.score == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"score");
			sprintf(field_value[i],"'%.1f'",p_data->seg.seg_send_contest.score);
		}
		else
		{
			p_data->seg.seg_send_contest.score=atof(field_value[i]);						
		}
		i++;
	}
	if(p_data->flag.flag_send_contest.tutor_score == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"tutor_score");
			sprintf(field_value[i],"'%.1f'",p_data->seg.seg_send_contest.tutor_score);
		}
		else
		{
			p_data->seg.seg_send_contest.tutor_score=atof(field_value[i]);						
		}
		i++;
	}
	if(p_data->flag.flag_send_contest.place_in_contest == 1)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"place_in_contest");
			sprintf(field_value[i],"%d",p_data->seg.seg_send_contest.place_in_contest);
		}
		else
		{
			p_data->seg.seg_send_contest.place_in_contest=atoi(field_value[i]);				
		}
		i++;
	}
	if(p_data->opr_mode == DB_SELECT||p_data->opr_mode==DB_FUZZY_SELECT)
	{
		if(mode == 0)
		{
			strcpy(field_name[i],"(select name from contest where contest_id=send_contest.contest_id) as contest_name");
		}
		else
		{
			strcpy(p_data->seg.seg_send_contest.contest_name,field_value[i]);					
		}
		i++;//k++;
	}
		
	data_send_contest[row_id] = p_data->seg.seg_send_contest;		
	field_num= i;
	table_num=k;
	return TRUE;
}