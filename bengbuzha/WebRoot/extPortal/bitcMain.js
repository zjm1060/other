...
Ext.onReady(function() {
	...
	var loginfo = '<div>'
			...
			+ ''
			+ ';">'
			+ '<a href = "http://192.168.18.119" target="_blank"><img src="resources/images/woix.png" alt="woix" title="woix" width="135" height="40" /></a>'
			+ '</div>'
			// + '<div style="position: absolute; bottom: 1px; right:260px;display:;">'
			// + '<a href = "http://inner.iwhr.com/innerlogin/"  target="_blank"><img src="resources/images/diwhr.png" width="50" height="50" alt="水文局上下水位" title="水文局上下水"/></a></div>'
