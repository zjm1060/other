		...
		.onReady(function() {
			...
			var store = new Ext.data.Store({
				...
				baseParams : {
					start : 0,
					limit : pageSize,
					attachmentTypeID : com.bitc.xmis.Attachment.incomeAccount
				},
				autoLoad : true,
			...
			var salaryexcelimportWin = new com.bitc.xmis.salaryExcelImportWin({
				...
				url : String.format(
					...
					__cxtPath, com.bitc.xmis.Attachment.incomeAccount, '-99', '2'),
				listeners : {
														...
														function(buttonId) {
															if (buttonId == 'yes') {
																...
																Ext.Ajax
																		.request({
																			url : __cxtPath
																				+ '/bbzFinancyMain.do?method=importYearSalarySheetList',
																			method : 'post',
																			params : {
																				attID : attID,
																				sheetIndex : indexStr,
