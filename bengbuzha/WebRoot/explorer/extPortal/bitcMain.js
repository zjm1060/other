...
xMis.turn = function(id, title, url, iconCls, refresh) {
	...
	// Ext.Msg.alert("提示", "最多只能有" + xMis.maxTabSize + "个页签，请关闭部分页签后重新操作。");
	// return;
	// }
...
function showSelfInfo() {
	...
	Ext.Ajax.request({
				url : __cxtPath + '/orgMaint.do?method=getEmpPathByEmpId',
				method : 'post',
				params : {
					id : empID
				},
					...
					parent.xMis
							.turn(
									...
									__cxtPath
											...
											+ __emp.companyID + '&tab=1&path='
											+ path, 'menu-company-info', true);
				},
...
Ext.onReady(function() {
	...
	// if (__emp.divisionID == 1 || __emp.divisionID == 2 || __emp.divisionID ==
	// 9) {
	// FTPdisplayPram = '';
	// } else {
	// FTPdisplayPram = 'none';
	...
	var loginfo = '<div>'
			...
			// + displayPram
			// + ';">'
			// + '<a href = "extPortal/forward_bug.jsp" target="_blank"><img
			// src="resources/images/dbug.png" width="50" height="50" alt="缺陷管理"
			// title="缺陷管理"/></a>'
			// + '</div>'
			// + '<a href = "ftp://192.169.11.39" target="_blank"><img
			// src="resources/images/dftp.png" width="50" height="50"
			// alt="FTP管理" title="FTP"/></a>'
			+ '<div style="position: absolute; bottom: 1px; right:310px;display:'
			+ ''
			+ ';">'
			+ '<a href = "http://192.168.18.119" target="_blank"><img src="resources/images/Woix生产实时系统.png" alt="Woix生产实时系统" title="Woix生产实时系统" width="135" height="40" /></a>'
			+ '</div>'
			// + '<div style="position: absolute; bottom: 1px;
			// right:260px;display:;">'
			// + '<a href = "http://inner.iwhr.com/innerlogin/"
			// target="_blank"><img src="resources/images/diwhr.png" width="50"
			// height="50" alt="水科院内网" title="水科院内网"/></a></div>'
			...
			// + '<a class="loginfo" href="javascript:;"
			// onclick="showSetting();">'
			+ '<a class="loginfo" href="javascript:;" title="进入个人信息" onclick="showSelfInfo();">'
			+ __emp.userName + '</a>&nbsp;&nbsp;'
			// + '<a class="loginfo" href="javascript:;"
			// onclick="xMis.saveUserHabit();" id="saveHabitLink" >保存用户习惯</a>'
			+ '&nbsp;&nbsp;<a class="loginfo" href="javascript:;" onclick="xMis.logout();">注销</a></div></div></div>';
	...
	var statusPanel = new Ext.Panel({
		...
		html : '<div style=" height:15px; ">'
				...
				// + '<span
				// style="color:white">&nbsp;研发单位:&nbsp;&nbsp;北京中水科技&nbsp;&nbsp;监控事业部&nbsp;<a
				// href="mailto:jklix@iwhr.com">技术开发部</a>&nbsp;&nbsp;&nbsp;&nbsp;联系电话
				// 1190&nbsp;分机&nbsp;11,18,20</span> &nbsp;</div>'
				+ '<span style="color:white">&nbsp;研发单位:&nbsp;&nbsp;北京中水科水电科技开发有限公司</span> &nbsp;</div>'
				+ '<div	style="float:right;margin:0 0 0 20px;font:normal 12px tahoma, arial, sans-serif, 宋体;" >'
				+ '<span style="color:white"><a href="操作手册.doc">操作手册</a>&nbsp;&nbsp;<a href="javascript:;" onClick="xMis.turnToMenu(\'\',\'organization/addressBook.jsp\',\'通讯录\');">通讯录</a>&nbsp;&nbsp;版本号：'
	...
	/**
	 * var newTodoList = new com.bitc.xmis.workflow.TodoList({ state : 0,
	 * showHeight:true, listSize : 0 }); var myTodoList = new
	 * com.bitc.xmis.workflow.TodoList({ state : 1, showHeight:true, listSize :
	 * 0 });
	 */
	...
	var currentAndNextAbsentInfoGroupGrid = new com.bitc.xmis.CurrentAndNextAbsentInfoGroupGrid();
	xMis.addRefresh('currentAndNextAbsentInfoGroupGrid', function() {
				this.reload()
			}, currentAndNextAbsentInfoGroupGrid);
	var applyMeetingFormTipsGrid = new com.bitc.xmis.ApplyMeetingFormTipsGrid();
	var task = {
		run : function() {
			applyMeetingFormTipsGrid.store.reload();
		},
		interval : timer_task_interval
	}
	var runner = new Ext.util.TaskRunner();
	runner.start(task);

	this.applyMeetingFormTipsGrid = function() {
		return applyMeetingFormTipsGrid;
	}
		...
		items : [{
			...
			items : [{
				...
				html : '<div style=font-size:13px;padding-top:0px;padding-bottom: 5px;sans-serif, 宋体;border-bottom:2px solid #2e8fba;>上次登录：'
						...
						+ ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本周登录：'
						+ logCount
						+ '&nbsp;次<br/><br/><!--<a href="http://192.168.103.241:5880/download/"  target="_blank"><img src="resources/images/fastmsgicon.jpg" width="20" height="20"  alt="FastMsg" title="FastMsg"/></img>FastMsg企业即时通讯客户端软件下载</a>--></div>'
				...
				tools : [{
							...
							qtip : '查看所有传阅通知',
							handler : function() {
								xMis.turn('my-messageInfo', '所有传阅通知', __cxtPath
			...
			items : [
				...
				tools : [{
							...
							qtip : '刷新',
							handler : function() {
								applyMeetingFormTipsGrid.reload();
							}
						}],
				items : applyMeetingFormTipsGrid
					// }, {
					// title : '收付款提示',
					// tools : tools
					// // collapseFirst : false,
				...
				items : currentAndNextAbsentInfoGroupGrid
			}]
		}]
	};
