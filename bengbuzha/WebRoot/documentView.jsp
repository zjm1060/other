...
<%
	...
	String swfFileNameOnly = (String) request.getAttribute("swfFileNameOnly");
	String swfFilePath = "pdf/" + swfFileNameOnly + ".swf";
...
<div style='padding-top:5px;padding-bottom: 5px;font-size:14px; '> </div>
