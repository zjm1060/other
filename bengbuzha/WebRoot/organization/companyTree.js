function buildPanel(compID) {
	...
	var dutylevelCombo = new com.bitc.xmis.Combos.DutyLevelCombo({
				fieldLabel : '职务级别',
				width : 180,
				hiddenName : 'dutylevelCombo'
			});

	var echnicalpositionCombo = new com.bitc.xmis.Combos.EchnicalpositionCombo(
			{
				fieldLabel : '技术职务',
				width : 180,
				hiddenName : 'echnicalpositionCombo'
			});

	var professionallevelCombo = new com.bitc.xmis.Combos.ProfessionalLevelCombo(
			{
				fieldLabel : '专业技术级别',
				width : 180,
				hiddenName : 'professionallevelCombo'
			});

	var DegreeCombo = new com.bitc.xmis.Combos.DegreeCombo({
				fieldLabel : '现有文化程度',
				width : 180,
				hiddenName : 'DegreeCombo'
			});

	var WorkTypeCombo = new com.bitc.xmis.Combos.WorkTypeCombo({
				fieldLabel : '工种',
				width : 180,
				hiddenName : 'WorkTypeCombo'
			});

	var identityCombo = new com.bitc.xmis.Combos.IdentityObjCombo  ({
				fieldLabel : '身份',
				width : 180,
				hiddenName : 'identityCombo'
			});
	...
	var Human = Ext.data.Record.create([{
				...
				type : 'string',
				convert : function(v, record) {
					return record.dutylevel == null ? null : record.dutylevel.id;
				}
			}, {
				name : 'echnicalpositionID',
				type : 'string',
				convert : function(v, record) {
					return record.echnicalposition == null ? null : record.echnicalposition.id;
				}
			}, {
				name : 'professionallevelID',
				type : 'string',
				convert : function(v, record) {
					return record.professionallevel == null ? null : record.professionallevel.id;
				}
			}, {
				name : 'worktypeID',
				type : 'string',
				convert : function(v, record) {
					return record.worktype == null ? null : record.worktype.id;
				}
			}, {
				name : 'identityID',
				type : 'string',
				convert : function(v, record) {
					return record.identity == null ? null : record.identity.id;
				}
			}, {
				name : 'DegreeID',
				type : 'string',
				convert : function(v, record) {
					return record.degree == null ? null : record.degree.id;
				}
			}, {
				name : 'disabledFlag',
				type : 'string',
				...
				type : 'string',
				convert : function(v, record) {
//					return record.postList[0] != null
//							? (record.postList[0].post != null
...
//							: '';
				...
				"mapping" : "echnicalposition",
				"name" : "echnicalposition"
			}, {
				"mapping" : "professionallevel",
				"name" : "professionallevel"
			}, {
				"dateFormat" : "Y-m-d",
				"mapping" : "getqualificationtime",
				"name" : "getqualificationtime",
				"type" : "date"
			}, {
				"dateFormat" : "Y-m-d",
				"mapping" : "text1",
				...
				"dateFormat" : "Y-m-d",
				"mapping" : "joinworkdate",
				"name" : "joinworkdate",
				"type" : "date"
			}, {
				"dateFormat" : "Y-m-d",
				"mapping" : "joinpartydate",
				"name" : "joinpartydate",
				"type" : "date"
			}, {
				"dateFormat" : "Y-m-d",
				"mapping" : "joingroupdate",
				"name" : "joingroupdate",
				"type" : "date"
			}, {
				"dateFormat" : "Y-m-d",
				"mapping" : "retirementdate",
				"name" : "retirementdate",
				"type" : "date"
			}, {
				"mapping" : "degree",
				...
				"mapping" : "thetimeandschoolandprofessional",
				"name" : "thetimeandschoolandprofessional",
				"type" : "string"
			}, {
				"mapping" : "remark1",
				"name" : "remark1",
	...
	var rowWork = {
		xtype : 'panel',
		height : (isAdmin || isDirectDeptAdmin) ? 950 + 700 : 930 + 700,
		border : false,
		items : [{
			...
			items : [{
						...
						items : [
								...
								},
								{
									...
									width : 180,
									listeners : {
										change : function(birth, newValue,
												oldValue) {
									...
									id : 'positionEdit',
									width : 180
								},  echnicalpositionCombo,
								professionallevelCombo, DegreeCombo,
								WorkTypeCombo,identityCombo,{
									xtype : 'datefield',
									format : 'Y-m-d',
									name : 'getqualificationtime',
									fieldLabel : '资格取得时间',
												...
												focus : function(ra) {
													...
													var win = new Ext.Window({
														...
														buttons : [{
															text : "确认",
															disabled : (isAdmin
																	|| compID != 1 || (isDirectDeptAdmin && mydivisionID == __emp.divisionID))
																	? false
																	: true,
															handler : function() {
																if (win.form
...
//					dutylevelCombo.setValue(Ext.getCmp("dutylevelID").getValue());
					echnicalpositionCombo.setValue(Ext.getCmp("echnicalpositionID").getValue());
					professionallevelCombo.setValue(Ext.getCmp("professionallevelID").getValue());
					DegreeCombo.setValue(Ext.getCmp("DegreeID").getValue());
					WorkTypeCombo.setValue(Ext.getCmp("worktypeID").getValue());
					identityCombo.setValue(Ext.getCmp("identityID").getValue());
