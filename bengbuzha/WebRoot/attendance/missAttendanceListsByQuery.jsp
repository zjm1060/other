  ...
  <head>
    ...
    <style type="text/css">
      body .x-panel { margin-bottom: 0px; }
			...
			<script type="text/javascript" src="<%=path%>/resources/js/ActionListColumn.js"></script>
    ...
    <script type="text/javascript" src="<%=path%>/attendance/missAttendanceListsByQuery.js"></script>
