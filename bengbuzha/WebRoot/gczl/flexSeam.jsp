...
<html>
  <head>
   ...
   <script type="text/javascript" src="<%=path%>/gczl/flexSeamSearch.js"></script>
   <script type="text/javascript" src="<%=path%>/gczl/flexSeam.js"></script>
   <script type="text/javascript" src="<%=path%>/gczl/fsSearch.js"></script>
