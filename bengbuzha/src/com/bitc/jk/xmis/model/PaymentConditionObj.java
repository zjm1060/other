...
public class PaymentConditionObj {
	 ...
	 * 
	 * @param aContractNo
	 *            the new value of the contractNo property
	 */
	 ...
	 * 
	 * @param aContractName
	 *            the new value of the contractName property
	 */
	 ...
	 *            the new value of the paymentConditionID property
	 */
	 ...
	 * 
	 * @param aProjectStatusMapping
	 *            the new value of the projectStatusMapping property
	 */
	 ...
	 * 
	 * @param aProjectStatusName
	 *            the new value of the projectStatusName property
	 */
	 ...
	 * 
	 * @param aDelayDays
	 *            the new value of the delayDays property
	 */
	 ...
	 * 
	 * @param aPaymentPercent
	 *            the new value of the paymentPercent property
	 */
	public void setPaymentPercent(double aPaymentPercent) {
	 ...
	 * 
	 * @param aPamymentAmt
	 *            the new value of the pamymentAmt property
	 */
	...
	public String getPaymentNodeName() {
		return paymentNodeName;
	}

	public void setPaymentNodeName(String paymentNodeName) {
		this.paymentNodeName = paymentNodeName;
	}

	public Date getShouldPaymentDate() {
		return shouldPaymentDate;
	}

	public void setShouldPaymentDate(Date shouldPaymentDate) {
