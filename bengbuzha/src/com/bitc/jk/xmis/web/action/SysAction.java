 ...
 * */	
	...
	public void getDutyLevel(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		String store = sysService.getDutyLevel();
		WebUtil.returnResponse(response, store);
	}
	
	public void getEchnicalposition(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
	throws Exception {
		String store = sysService.getEchnicalposition();
		WebUtil.returnResponse(response, store);
	}
	
	public void getProfessionalLevel(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
	throws Exception {
		String store = sysService.getProfessionalLevel();
		WebUtil.returnResponse(response, store);
	}
	
	public void getDegree(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
	throws Exception {
		String store = sysService.getDegree();
		WebUtil.returnResponse(response, store);
	}
	
	public void getWorkType(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
	throws Exception {
		String store = sysService.getWorkType();
		WebUtil.returnResponse(response, store);
	}
	
	public void getInServiceType(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
	throws Exception {
		String store = sysService.getInServiceType();
		WebUtil.returnResponse(response, store);
	}
	
	public void getIdentityObjCombo(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
	throws Exception {
		String store = sysService.getIdentityObjCombo();
		WebUtil.returnResponse(response, store);
	}
	/**
	 * 办公用品
	 * */
	public void getOfficeSuppliesCombo(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
	throws Exception {
		String store = sysService.getOfficeSuppliesCombo();
		WebUtil.returnResponse(response, store);
	}
