...
public class SysServiceImpl implements SysService {
	...
	public String getDutyLevel() {
		List<DutyLevel> lists = sysDAO.getDutyLevel();
		String store = WebUtil.buildJsonStoreByList(lists);
		return store;
	}

	public String getEchnicalposition() {
		List<Echnicalposition> lists = sysDAO.getEchnicalposition();
		String store = WebUtil.buildJsonStoreByList(lists);
		return store;
	}

	public String getProfessionalLevel() {
		List<ProfessionalLevel> lists = sysDAO.getProfessionalLevel();
		String store = WebUtil.buildJsonStoreByList(lists);
		return store;
	}

	public String getDegree() {
		List<Degree> lists = sysDAO.getDegree();
		String store = WebUtil.buildJsonStoreByList(lists);
		return store;
	}

	public String getWorkType() {
		List<WorkType> lists = sysDAO.getWorkType();
		String store = WebUtil.buildJsonStoreByList(lists);
		return store;
	}

	public String getInServiceType() {
		List<InServiceType> lists = sysDAO.getInServiceType();
		String store = WebUtil.buildJsonStoreByList(lists);
		return store;
	}

	public String getIdentityObjCombo() {
		List<IdentityObj> lists = sysDAO.getIdentityObjCombo();
		String store = WebUtil.buildJsonStoreByList(lists);
		return store;
	}

	@Override
	public String getOfficeSuppliesCombo() {
		// TODO Auto-generated method stub
		List<OfficeSupplies> lists = sysDAO.getOfficeSuppliesCombo();
		String store = WebUtil.buildJsonStoreByList(lists);
		return store;
	}
