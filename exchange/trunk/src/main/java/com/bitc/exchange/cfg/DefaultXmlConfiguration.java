 ...
 */
public class DefaultXmlConfiguration implements Configuration {
    ...
    public DefaultXmlConfiguration() throws ConfigurationException {
        this(null);
    }

    public DefaultXmlConfiguration(String exchangeFile) throws ConfigurationException {
        SAXReader reader = new SAXReader();
        try {
            if (exchangeFile == null) {
                exchangeFile = "/exchange.xml";
            }
            Document document = reader.read(this.getClass().getResourceAsStream(exchangeFile));
