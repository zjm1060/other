...
function AddClick(){
  returnvalue=window.showModalDialog("AddUserRight.jsp?addtype=modu","","dialogHeight:600px;dialogWidth=800px;center:yes;edge:raised;scroll:no;status:no;unadorned:yes;");
  if (returnvalue==1)
