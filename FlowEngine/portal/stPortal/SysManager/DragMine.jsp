...
<%@ page language="java" import="jbportal.PortalUtil,com.minstone.util.database.RecordSetObject" %>
...
<script type="text/javascript" src="../include/drag/layout.js"></script>
<script type="text/javascript" src="../include/drag/Drag.js"></script>
