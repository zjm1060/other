...
<%
	...
	String m_modu_id = request.getParameter("m_modu_id");
    String m_Operation = "0";

	if (m_Operation.equals("0")){
        RecordSetObject m_Rstemp = oManager.rsGetModuFunction(m_modu_id,m_func_id);
	...
	String sOnHeightClick = " onClick='JavaScript:IniHeightEnabled();' ";
	String sOnWidthClick=" onClick='JavaScript:IniWidthEnabled();' ";
	String m_StrHeightEnabled1 = "<INPUT TYPE='RADIO' NAME='HeightEnabled' VALUE='1' " + sCheckedYes + sOnHeightClick + " >Yes&nbsp;</INPUT>";
	String m_StrHeightEnabled2 = "<INPUT TYPE='RADIO' NAME='HeightEnabled' VALUE='0' " + sCheckedNo + sOnHeightClick + " >No&nbsp;</INPUT>";
	//高度单位
	...
	String m_StrWidthEnabled1 = "<INPUT TYPE='RADIO' NAME='WidthEnabled' VALUE='1' " + sCheckedYes + sOnWidthClick + " >Yes&nbsp;</INPUT>";
	String m_StrWidthEnabled2 = "<INPUT TYPE='RADIO' NAME='WidthEnabled' VALUE='0' " + sCheckedNo + sOnWidthClick + " >No&nbsp;</INPUT>";
	//宽度单位
	String m_StrWidthUnitType =jbportal.PortalUtil.ArrayOptions(m_UnitTypeValue,m_UnitType,m_WidthUnitType);
	//建立区域子串用于显示
	//进行页面的返还处理
	String ms_BackURL ="funcList.jsp?modu_id=" + m_modu_id;
%>
<html>
