...
<link href="../css/style.css" rel="stylesheet" type="text/css">
  ...
  */		
  ...
  <Script>
 if (document.all) {
    //alert("你的浏览器是:Microsoft Internet explorer");
    var version=navigator.appVersion+";";
    var IEname=version;
    //alert(version);
    version=version.split(";");
    version=version[1];
    if(IEname.search("Maxthon")!=-1 || IEname.search("Tencent")!=-1 )
    	alert("为了更方便使用本系统，请使用Microsoft Internet explorer");
    else{
     version=version.replace(" ","");
     if(version.substring(5,6)<6)
    	alert("为了更方便使用本系统，请使用Microsoft IE 6.0或更高的版本！登录系统后，在《下载中心》栏目下载最新的IE程序。");
    }
 }else {
    alert("为了更方便使用本系统，请使用Microsoft Internet explorer");
}
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR vAlign=top>
    <TD class=subWebTab align=left colSpan=2>
      <FORM id="login_server" name="login_server" action="http://10.197.32.160/stPortal/default.jsp/j_security_check" method="post"  target=_top>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR onmouseover="this.style.backgroundColor='#f1f1f1';" onmouseout="this.style.backgroundColor='#ffffff';" align=right>
          <TD colspan=3 class=subTab vAlign=bottom align=left height="">
          	请在此登录办公自动化系统。
          	<A href="/STPublish/view/ViewRecord.jsp?id=2" target="_blank">
          		为了更好办公，请设置使用环境。</A></TD>        
        </TR>
