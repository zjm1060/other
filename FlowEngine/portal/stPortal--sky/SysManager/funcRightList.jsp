...
function AddClick(){
  returnvalue=window.showModalDialog("AddUserRight.jsp?addtype=func","","dialogHeight:400px;dialogWidth=677px;center:yes;edge:raised;scroll:no;status:yes;unadorned:yes;");
  if (returnvalue==1)
