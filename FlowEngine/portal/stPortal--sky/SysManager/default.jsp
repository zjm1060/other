...
<BODY topmargin="0" leftmargin="0" bgcolor="White" scroll="no">
					...
					<table height="100%" cellpadding="0" cellspacing="0" border="0">
						<tr class="DashTitleGroup">
							...
							<td class="DashTitleSpacer">
								<img width="150px" height="1px" src="../include/pixel.gif" />
							</td>
						</tr>
					</table>
				</td>
	...
	<TABLE cellspacing="0" cellpadding="0" width="100%" class="DashNavArea" border="0" >
		...
		<tr><td height="100%">
			<TABLE HEIGHT=100% width="100%">
				<TR><TD>
				<IFRAME ID=IFrame1 FRAMEBORDER=1 width="100%" height="100%" SCROLLING=NO></IFRAME>
				</TD>
                                        </TR>
			</TABLE>
		</td></tr>
