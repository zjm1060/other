				...
				<TR>
					...
					<fieldset style="padding:6px;width:100%">
						...
						<TABLE WIDTH="100%" class="InnerTable">
							<TR>
								<TD CLASS="CustSectionRight"><input type="label" style="width:30" class="Input_Label" Value="名称:"></TD>
								<TD CLASS="CustSectionRight" >
									<input type="text" maxlength="100" name="Title" style="width:180; overflow:hidden" class="input_Normal" autocheck="1" propname="名称" cannull="0"  value="<%=m_Title%>" >
								</TD>
