...
/*     aHeight：按钮的高（像素）*/
/************************/
function menu1_addItem(aName,aNormalImg,aSelectImg,aOverImg,
                        aDes,aAttach,aLeft,aWidth,aHeight){
  var temp="";

  temp = "<span style=\"position:relative;width:"+aLeft+"px;\"></span>"
       + "<span id=\""+aName+"_out\" name=\""+aName+"_out\" widthValue=\""+aWidth
       + "\" heightValue=\""+aHeight+"\" class=\"menu1_normalItem_out\" style=\"width:"
       + aWidth+"px;height:"+aHeight+"px;\">"
       + "<span id=\""+aName+"_middle\" name=\""+aName+"_middle\" widthValue=\""+aWidth
       + "\" heightValue=\""+aHeight+"\" class=\"menu1_normalItem_middle\" style=\"width:"
       + aWidth+"px;height:"+aHeight+"px;\"><span id=\""+aName+"_in\" name=\""
       + aName+"_in\" widthValue=\""+aWidth+"\" heightValue=\""+aHeight+"\" class=\"menu1_normalItem_in\""
       + " style=\"width:"+aWidth+"px;height:"+aHeight+"px;\""+aAttach+">"
       + "<img id=\""+aName+"_img\" name=\""+aName+"_img\" normalImg=\""+aNormalImg+"\""
       + " selectImg=\""+aSelectImg+"\" overImg=\""+aOverImg+"\" src=\""+aNormalImg+"\" border=\"0\"><br>"+aDes+"</span></span></span>";
...
function createMenu1(aDivName){
  menu1Html = "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr class=\"menu1_tr\"><td class=\"menu1_leftTd\">"+menu1Html+"</td><td class=\"menu1_rightTd\">&nbsp;</td></tr></table>";
...
/*     aHeight：按钮的高（像素）*/
/************************/
function ButtonBar_addItemEx(aName,aNormalImg,aSelectImg,aOverImg,aDes,aAttach,aLeft,aWidth,aHeight){
  var temp="";

  temp = "<span style=\"position:relative;width:"+aLeft+"px;\"></span><span id=\""+aName+"_out\" name=\""+aName+"_out\" class=\"button_normal_out\" style=\"width:"+aWidth+"px;height:"+aHeight+"px;\"><span id=\""+aName+"_in\" name=\""+aName+"_in\" class=\"button_normal_in\" style=\"width:"+aWidth+"px;height:"+aHeight+"px;\""+aAttach+"><img id=\""+aName+"_img\" name=\""+aName+"_img\" normalImg=\""+aNormalImg+"\" selectImg=\""+aSelectImg+"\" overImg=\""+aOverImg+"\" src=\""+aNormalImg+"\" border=\"0\"><span class=\"button_word\">"+aDes+"</span></span></span>";
...
function ToolBar_addItem(aName,aNormalImg,aAttach,aDes,aWidth){
  var normalClass="button_normal_ex",mousedownClass="button_mousedown_ex",overClass="button_over_ex";
  var ls_Attach ="onclick=\"javascript:"+ aAttach +";\"";;
  ls_Attach +=" onmouseover=\"javascript:buttonItemOver('"+aName+"');\"";
  ls_Attach += " onmouseout=\"javascript:buttonItemOut('"+aName+"');\"";
  ls_Attach += " onmousedown=\"javascript:buttonItemMouseDown('"+aName+"');\"";
  ls_Attach +=" onmouseup=\"javascript:buttonItemMouseUp('"+aName+"');\"";
  ButtonBar_addItem(aName,aNormalImg,"","",normalClass,mousedownClass,overClass,aDes,ls_Attach,"3",aWidth,"23");
}

function ToolBar_addItemEx(aName,aNormalImg,aAttach,aDes,aWidth){
