...
//	var sTool="Tool"+index
	...
	if (toolbarImgOver[index]!=''&& toolbarImgNormal[index] != '')
	{
...
//		sTmp= toolbarImgNormal[index]
	...
	{
		sTool += "<TBODY><TR>"
                if(toolbarImgNormal[index] != ''){
                  sTool += " <TD> <P style=\"MARGIN-RIGHT: 2px\"><IMG border=0 "
    ...
    }else
    {
                sTool += "<TBODY><TR>"
                if(toolbarImgNormal[index] != ''){
                  sTool += " <TD align=center> <P style=\"MARGIN-RIGHT: 2px\"><IMG border=0 "
                  sTool += " height=16 id="+sImg+"  src=\""
                  sTool +=  toolbarImgNormal[index] + "\" width=16>"
                  sTool += "</P></TD>"
                }
