...
public:
	...
	void formatAndAppend(QExclusiveTextStream& output, const QLoggingEvent& event);
...
typedef QTemplateFactory<QPatternLogLayout, QLogLayoutFactoryBase>			QPatternLogLayoutFactory;
