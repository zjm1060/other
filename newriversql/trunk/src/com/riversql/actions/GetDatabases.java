...
public class GetDatabases implements JSONAction {
	...
	public JSONObject execute(HttpServletRequest request,
		...
		for (SQLSession sqlsession : sessions.getSqlsessions()) {
            ...
            boolean hasSchemas=sqlsession.getDatabaseNode().supportsSchemas();
            if(hasSchemas){
                String[] schemas=sqlsession.getDatabaseNode().getSchemas();
                obj.put("schemas",Arrays.asList(schemas));
            }
			arr.put(obj);
		}
