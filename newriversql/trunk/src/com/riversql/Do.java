...
public class Do extends DoServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        tmp.put("upload",Upload.class);
        tmp.put("importstep1",ImportStep1.class);
        tmp.put("importstep2",ImportStep2.class);

        tmp.put("task",TaskAction.class);
        ...
        tmp2.put("tempFileDownload",TempFileDownload.class);
