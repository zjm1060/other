<div id="home" style="padding:5px">
	...
	<p style="padding:20px;line-height: 250%;">
		...
		<img src="icons/cog.png" style="width:16px;height:16px;vertical-align:middle"/>&nbsp;&nbsp;<a class="page" href="#" onclick="createTaskShow()">ShowTask</a><br/>
		<img src="icons/cog.png" style="width:16px;height:16px;vertical-align:middle"/>&nbsp;&nbsp;<a class="page" href="#" onclick="ShowImportLog()">ShowImportLog</a><br/>
