Ext.define("bitc.wrenv.inputview.inputYuQiao_wendu", {
                ...
                this.add(Ext.create('Ext.form.Panel',{
                    ...
                    items:[{
                        ...
                        columns: [
                            ...
                            {
                                text: '温度(°C)', dataIndex: 'wendu', flex: 1, editor: {
                                xtype: 'textfield',
                                saveBtnText: '保存',
                                cancelBtnText: "取消",
                                allowBlank: false
    ...
    onSave:function(){
        ...
        if (baseForm.isValid()) {
            ...
            baseForm.submit({
                url: __path + '/inputview/addWenDuData.do',
                method: 'post',
                params: {
                    planId:this.planId,
                    index:index,
    ...
    onDelete:function(){
        ...
        var index =  this.items.indexOf(baseForm)+1;
        var data={};
        data['C22_NCSER2']= (this.items.length-1)+'';
        Ext.MessageBox.confirm("提示","确定要删除此项配置？",function(e){
            if(e =='yes'){
                Ext.Ajax.request({
                    ...
                    params: {
                        planId: me.planId,
                        fileId:'2304795F58E9444390159AC6C736B4B9',
    ...
    requestDataFromDB:function(){
        ...
        Ext.Ajax.request({
            url:__path+'/inputview/getYuQiaoWenduFileData.do',
            method:'POST',
            scope:this,
            params:{
                planId:this.planId
