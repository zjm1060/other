 ...
 */
Ext.define('bitc.report.plugins.DateTimePicker', {
    extend: 'Ext.picker.Date',//继承于 Ext.picker.Date
    alias: 'widget.sz_DateTimePicker',//别名
    okText:'确定',//确认按钮文字描述
    okTip:'确定',//确认按钮提示内容
    ...
    renderTpl: [
        ...
        //指定时分秒渲染框架
        '<table id="{id}-timeEl" style="table-layout:auto;width:30px;margin:0 3px;" class="x-datepicker-inner" cellspacing="0">',
        '<tbody><tr>',
